        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <a class="navbar-brand" href="{{route('cliente.menu')}}"><img src="{{asset('src/logo.png')}}" width="60px" height="60px" alt=""></a>
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('historialCliente')}}"><i class="fa-solid fa-clipboard-list" style="color: #ffffff;"></i> Historial</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('ordenCliente')}}"><i class="fas fa-file-invoice-dollar" style="color: #ffffff"></i> Nota</a>
                  </li>
